...
const contactMethods = [
  {
    ...
    action: 'ramirezhernandezzaidalberto@gmail.com',
    href: 'mailto:ramirezhernandezzaidalberto@gmail.com',
    color: 'red',
  },
  {
    icon: FaGithub,
      ...
      <Container maxW="7xl" justifySelf="center" px={{ base: 4, sm: 6, md: 8 }}>
        <VStack gap={{ base: 8, md: 12 }}>
          ...
          <VStack gap={4} pt={{ base: 4, md: 8 }} width={{ base: "100%", sm: "auto" }} px={{ base: 2, sm: 0 }}>
            <Link href="mailto:ramirezhernandezzaidalberto@gmail.com" _hover={{ textDecoration: 'none' }} width={{ base: "100%", sm: "auto" }}>
              <Button
                size={{ base: "md", sm: "lg" }}
                colorPalette="blue"
